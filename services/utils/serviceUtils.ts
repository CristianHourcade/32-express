import type { Business, Product, Employee, Sale, Shift, Expense, Activity } from "@/services/types"

// Función para manejar errores de servicio de manera consistente
export const handleServiceError = (error: any, serviceName: string, methodName: string) => {
  ...
  // Podemos agregar lógica adicional aquí, como enviar el error a un servicio de monitoreo
